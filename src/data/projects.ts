...
export const projects: Project[] = [
  {
    ...
    tools: ["React", "TypeScript", "Tailwind", "Supabase", "AI Assistant"],
    outcome:
  ...
  },
  {
    ...
    tools: ["React", "TypeScript", "OpenAI API", "Node.js"],
    outcome:
  ...
  {
    title: "Tiny Tiger CRM",
    type: "Customer Relationship Management Tool",
    problem:
    ...
    solution:
      "A lightweight CRM for tracking clients, leads, and follow-ups in one place, built for small-business workflows rather than enterprise sales teams.",
  ...
  },
  {
    ...
    tools: ["React", "TypeScript", "Supabase", "AI Assistant"],
    outcome:
